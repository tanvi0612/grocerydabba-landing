...
const CounterBar = styled.div`background: #33a1fd2e;`;
				...
				<SplashGrid>
					<SplashContent>
						<ScrollAnimation animateIn="fadeIn">
							<h1>Delivering all your Indian grocery needs to your doorstep.</h1>
						</ScrollAnimation>
						<ul>
							<ScrollAnimation animateIn="fadeIn" delay={300}>
								<li>Shop at your convenience and let us take care of the rest</li>
							</ScrollAnimation>
							<ScrollAnimation animateIn="fadeIn" delay={600}>
								<li>We bring you the best quality ingredients for that perfect Indian meal. Yum!</li>
							</ScrollAnimation>
						</ul>
